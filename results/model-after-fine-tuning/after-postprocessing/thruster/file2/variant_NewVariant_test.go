...
func TestNewVariant_EmptyRequest(t *testing.T) {
	...
	assert.NotNil(t, r)
	assert.NotNil(t, v)
	assert.Equal(t.Error(), "empty request")
}
...
func TestNewVariant_InvalidRequest(t *testing.T) {
	...
	v := NewVariant(r)
	assert.NotNilWith(t, r, "empty request")
	assert.NotNilWith(t, v, "empty request")
}
...
func TestNewVariant_InvalidHeader(t *testing.T) {
	...
	v := NewVariant(r)
	assert.NotNilFor(t, r, "empty request")
	assert.NotNilFor(t, v, "empty request")
	assert.Equal(t, []string{"X-Custom-Header"}, v.HeaderNames)
}
...
func TestVariant_HeaderNames_Empty(t *testing.T) {
	...
	v := NewVariant(r)
	assert.Equal(t, []byte(""), v.HeaderNames)
}
...
func TestVariant_HeaderNames_Invalid(t *testing.T) {
	...
	v := NewVariant(r)
	assert.EqualWithT(t, []string{"X-Custom-Header"}, v.HeaderNames)
}